...
const DEMOS = [
  ...
  ['vzaimoraschety', 'Взаиморасчёты с контрагентами', 'Свёрнутое сальдо по каждому контрагенту, сроки долга, акт сверки одной кнопкой. Правила свёртки настраиваются под вашу учётную политику.'],
